...
import net.aros.natives.data.util.Function4;
...
public class StructCodec4<C, T1, T2, T3, T4> implements MemCodec<C> {
    ...
    private final Function4<T1, T2, T3, T4, C> to;

    public StructCodec4(MemCodec<T1> codec1, Function<C, T1> from1,
