...
import net.aros.natives.data.util.Function6;
...
public class StructCodec6<C, T1, T2, T3, T4, T5, T6> implements MemCodec<C> {
    ...
    private final MemCodec<T6> codec6;
    private final Function<C, T6> from6;
    private final Function6<T1, T2, T3, T4, T5, T6, C> to;

    public StructCodec6(MemCodec<T1> codec1, Function<C, T1> from1,
